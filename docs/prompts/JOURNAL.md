...
|----|---------|------|--------|---------|----------|------|
| 010 | Stock cartes — barre visuelle testées/validées/à débugger par carte | feat | ✅ terminé | feat/stock-cartes-barre | PR → dev (réutilise ProductionSuiviBar du dashboard ; aucun changement backend) | 2026-07-22 |
