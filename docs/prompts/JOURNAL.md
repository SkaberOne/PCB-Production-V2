...
|----|---------|------|--------|---------|----------|------|
| 005 | Changement de footprint avec choix de portée (parité valeur 002, MPN suit) | feat | ✅ terminé | feat/footprint-portee | [PR #83](https://github.com/SkaberOne/PCB-Production-V2/pull/83) → dev (portée (valeur+ancien footprint) ; ScopeDialog générique ; MPN via match (valeur, footprint)) | 2026-07-22 |
