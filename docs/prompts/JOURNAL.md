...
|----|---------|------|--------|---------|----------|------|
| 007 | Conditionnement affiché + suivi « préparé / installé » par composant | feat | ✅ terminé | feat/suivi-preparation-prod | PR → dev (modèle ProductionComponentProgress ; cases Préparé/Installé + conditionnement, sans impact stock) | 2026-07-22 |
