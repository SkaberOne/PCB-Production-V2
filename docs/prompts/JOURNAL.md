...
|----|---------|------|--------|---------|----------|------|
| 008 | « Cartes » intégré comme onglet de « Base de données » (+ redirection /cartes) | feat | ✅ terminé | feat/cartes-dans-bdd | PR → dev (réutilise CardCatalogPage en onglet ; menu allégé) | 2026-07-22 |
